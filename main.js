...
// PASIEMIAU CARDA
var rezultatas = document.getElementById('results');

// ANT SEARCH INPUTO UZSIDEJAU EVENTA KEYUP 
...
// PRASUKAU DU CIKLUS KAD PASIEKTI 'NAME' IR IDEJAU I h2 IR I CARDA
    for (var i = 0; i < data.length; i++){
        for(var j = 0; j < data.length; j++){
        // console.log(data[0].breeds[0].name
        var teksto_laukas = document.createElement('h2');
        var vardas = data[i].breeds[j].name;
        teksto_laukas.innerHTML = vardas;
        rezultatas.appendChild(teksto_laukas);
